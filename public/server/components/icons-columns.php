        ...
        <div class="d-flex py-<?= $data['padding'] ?? 3 ?> justify-content-center" style='gap: 2rem;'>
            <?php foreach ($data['icons'] as $item): ?>
                <div style='max-width: 430px;'>
                    <div class="feature-icon bg-primary bg-gradient mb-4 d-inline-flex justify-content-center align-items-center"
                         style='display: inline-flex; width: 4rem; height: 4rem; border-radius: .75rem; color: #FFF;'>
